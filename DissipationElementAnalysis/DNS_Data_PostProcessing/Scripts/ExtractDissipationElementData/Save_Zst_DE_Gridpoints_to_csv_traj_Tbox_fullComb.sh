...
matlab -singleCompThread -nodisplay -nodesktop -nosplash -logfile jobs_out/job.${SLURM_JOB_ID}.txt <<EOF
run Save_Zst_DE_Gridpoints_to_csv_traj_Tbox_fullComb.m;
quit();
EOF
