...
## Job name and files
#SBATCH --job-name=DataGeneration
## OUTPUT AND ERROR
#SBATCH -o jobs_out/job.%j.out
#SBATCH -e jobs_out/job.%j.err
...
##SBATCH --mail-user=your_email	 # send notifications to this email REPLACE WITH YOUR EMAIL

## Setup of execution environment 
#SBATCH --export=NONE

## account and partition selection
#SBATCH --account='p0024040'
...
args='python3 CreateFigure.py -o ../OutputData/Submission -i ../InputData/Flamelets_preheated/* -vy grad,chi -vx Z -save'
