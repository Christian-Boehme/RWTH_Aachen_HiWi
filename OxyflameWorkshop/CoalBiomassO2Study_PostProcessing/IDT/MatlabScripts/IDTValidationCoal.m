...
%%%%%
% INPUTS
ifname_sim = '../Data/Simulations/Sim_IDT_Coal_AIR20.txt';
ifname_exp1 = '../Data/IDT_TaoLi/AIR20_C1.csv';
ifname_exp2 = '../Data/IDT_TaoLi/AIR20_C2.csv';
ifname_exp3 = '../Data/IDT_TaoLi/AIR20_C3.csv';
ofname = 'figures/IDTValidationCoal.eps';
markerSize = 75;
markerSizeSim = 10;
alphaValue = 0.5;
markerColor1 = '#add8e6';
...
text(175, 22, '(a) Coal', 'Interpreter', 'latex', 'FontSize', FZ, 'FontWeight', 'bold');
