...
tign_coal = 8.30
tign_ws   = 7.40
set arrow from tign_coal, graph 0 to tign_coal, graph 1 nohead lw 4 lc rgb "#1f78b4" dashtype 3
set arrow from tign_ws, graph 0 to tign_ws, graph 1 nohead lw 4 lc rgb "#e31a1c" dashtype 3
