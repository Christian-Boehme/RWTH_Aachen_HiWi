...
set out 'figures/VolatileFlameStandOffDistance_EffectOfSize_CoalBio_Air.eps'
...
# simulation data
f1 = '../../Data/4_NormalizedGrid/Sim_Coal_EffectOfSize_Air.csv'
f2 = '../../Data/4_NormalizedGrid/Sim_WS_EffectOfSize_Air.csv'
