...
set out 'figures/VolatileFlameStandOffDistance_DP125.eps'
...
set key spacing 1.0
p f1 u ($1*1000-8.3):(column('rf_minus_rp')) t 'Coal' w l lw 4 lc rgb '#1f78b4'\
 ,f2 u ($1*1000-7.4):(column('rf_minus_rp')) t 'WS' w l lw 4 lc rgb '#e31a1c'\
