...
factor = 60.13
# create figure
plt.plot(ia_T1300K['time[ms]'] * 1E+03, ia_T1300K['IntAvgNOx'] * 1E+06 * factor, marker='x', color='blue', label='T1300K')
plt.plot(ia_T1400K['time[ms]'] * 1E+03, ia_T1400K['IntAvgNOx'] * 1E+06 * factor, marker='x', color='green', label='T1400K')
plt.plot(ia_T1500K['time[ms]'] * 1E+03, ia_T1500K['IntAvgNOx'] * 1E+06 * factor, marker='x', color='red', label='T1500K')
