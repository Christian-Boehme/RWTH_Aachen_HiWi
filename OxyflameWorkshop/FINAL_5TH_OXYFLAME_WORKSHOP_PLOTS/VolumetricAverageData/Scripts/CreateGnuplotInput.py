...
def main(args=None):
    ...
    #parser.add_argument('-i3', type=str, required=False, help='(4) path to integrated average data (optional)')
    #parser.add_argument('-i3', type=str, required=False, help='(5) path to integrated average data (optional)')
    #parser.add_argument('-i3', type=str, required=False, help='(6) path to integrated average data (optional)')
    #
