...
set out '../figures_postscripteps/Glarborg2018_NH3_Lean.eps'
...
# Experiments
f1 = '../ExperimentalData/NH3/FR_NO_Lean.txt'
f2 = '../ExperimentalData/NH3/FR_NH3_Lean.txt'
...
set label '{/Symbol f} = 0.13' at graph 0.03, graph 0.90

set key at graph 0.875, graph 0.97 spacing 1.1 samplen -1.5
