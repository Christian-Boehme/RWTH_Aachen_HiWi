...
set out '../figures_postscripteps/Glarborg2018_RapReNOx_CPollutants.eps'
...
# Experiments
f1 = '../ExperimentalData/RapReNOx/FR_CO.txt'
f2 = '../ExperimentalData/RapReNOx/FR_CO2.txt'
...
p f1 u 1:($2*1E+00) t 'CO' w p ps 3 lw 3 pt 7 lc rgb 'blue'\
 ,f2 u 1:($2*1E+00) t 'CO_2' w p ps 3 lw 3 pt 9 lc rgb 'red'\
 ,f4 u ($1):((column('X-CO_0'))*1E+00) notitle w l lt 1 lw lwrefG lc rgb 'blue' dashtype 2\
 ,f4 u ($1):((column('X-CO2_0'))*1E+00) notitle w l lt 1 lw lwrefG lc rgb 'red' dashtype 2\
 ,f5 u ($1):((column('X-CO_0'))*1E+00) notitle w l lt 1 lw lwdetG lc rgb 'blue' dashtype 3\
 ,f5 u ($1):((column('X-CO2_0'))*1E+00) notitle w l lt 1 lw lwdetG lc rgb 'red' dashtype 3\
 ,f6 u ($1):((column('X-CO_0'))*1E+00) notitle w l lt 1 lw lwnewG lc rgb 'blue'\
 ,f6 u ($1):((column('X-CO2_0'))*1E+00) notitle w l lt 1 lw lwnewG lc rgb 'red'\
