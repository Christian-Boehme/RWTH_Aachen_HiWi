...
set out '../figures_postscripteps/Glarborg2018_ThermalDeNOx_O20.eps'
...
# Experiments
f1 = '../ExperimentalData/ThermalDeNOx/JSR_NO.txt'
...
set label 'X_{O_2} = 0.01' at graph 0.03, graph 0.10

set key at graph 0.225, graph 0.25 spacing 1.1 samplen -1.5
