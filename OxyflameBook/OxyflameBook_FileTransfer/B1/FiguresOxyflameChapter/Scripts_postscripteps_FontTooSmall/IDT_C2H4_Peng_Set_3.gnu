...
set out '../figures_postscripteps/IDT_C2H4_Peng_Set_3.eps'
...
# Experiments
f1 = '../ExperimentalData/IDT_C2H4_Peng_Set_3.txt'
# FM simulations
f4 = ARG1
f5 = ARG2

set label '{/Symbol f} = 1.0, p = 1 atm' at graph 0.03, graph 0.90
