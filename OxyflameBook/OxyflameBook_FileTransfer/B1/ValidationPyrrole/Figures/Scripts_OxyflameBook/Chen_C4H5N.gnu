...
set out '../Figures_OxyflameBook/Chen_C4H5N.eps'

set termoption enhanced
set encoding utf8

set xtics 700,200,10000
set ytics 0,3000,15000
set mxtics 2
set mytics 1
...
# Experiments
#f1 = '../ExperimentalData/Fig1_a_GC1.csv'
f2 = '../ExperimentalData/Fig1_a_GCMS2.csv'
f3 = '../ExperimentalData/Fig1_a_ToFMBMS.csv'
f4 = '../ExperimentalData/Fig1_a_Pelucchi.csv'
# FM simulations
f5 = ARG1
f6 = ARG2
f7 = ARG3
...
p f3 u ($1):($3*1E+06):($4*1E+06) notitle w filledcurves lc '#99ffcccc'\
 ...
 ,f5 u 1:((column('X-C4H5N'))*1E+06) notitle w l lt 1 lw lwref lc rgb lcref dashtype 2\
 ,f6 u 1:((column('X-C4H5N'))*1E+06) notitle w l lt 1 lw lwdet lc rgb lcdet dashtype 3\
 ,f7 u 1:((column('X-C4H5N'))*1E+06) notitle w l lt 1 lw lwnew lc rgb lcnew\
