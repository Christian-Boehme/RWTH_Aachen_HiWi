...
set out '../figures_postscripteps/B1b_LCai_IDT_CH4_Koroglu_Stoi_XCO2_060.eps'
...
# Experiments
f1 = '../ExperimentalData/Koroglu_Stoi_XCO2_060.txt'
# FM simulations
f4 = ARG1

set label '{/Symbol f} = 1.0' at graph 0.03, graph 0.90

set key at graph 1.025, graph 0.175 spacing 1.0 samplen 0.5
p f1 u 1:($2*1E+00):3:4 t '0.61 atm' w p ps 3 pt 7 lw 3 lc rgb '#1f78b4'\
 ,f4 u ($2):3 notitle w l lt 1 lw 6 lc rgb '#1f78b4'\
 ,f1 u 1:($2*1E+00):3:4 notitle w errorbars ps 3 pt 7 lw 3 lc rgb '#1f78b4'\
