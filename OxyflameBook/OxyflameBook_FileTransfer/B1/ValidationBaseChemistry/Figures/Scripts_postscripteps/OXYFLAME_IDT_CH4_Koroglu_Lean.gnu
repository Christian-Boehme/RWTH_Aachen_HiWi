...
set out '../figures_postscripteps/B1b_LCai_IDT_CH4_Koroglu_Lean.eps'

set encoding utf8
set termoption enhanced

set xtics 0.0,0.05,2.0
#set ytics 0,0.025,3000
set mxtics 2
set mytics 5
...
p f1 u 1:($2*1E+00) t '0.77 atm' w p ps 3 pt 7 lw 3 lc rgb '#1f78b4'\
 ,f2 u 1:($2*1E+00) t '3.92 atm' w p ps 3 pt 9 lw 3 lc rgb '#e31a1c'\
