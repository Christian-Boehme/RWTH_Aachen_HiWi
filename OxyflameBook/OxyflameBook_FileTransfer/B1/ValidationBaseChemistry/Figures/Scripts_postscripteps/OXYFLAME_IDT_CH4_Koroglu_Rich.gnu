...
set out '../figures_postscripteps/B1b_LCai_IDT_CH4_Koroglu_Rich.eps'
...
p f1 u 1:($2*1E+00) t '0.70 atm' w p ps 3 pt 7 lw 3 lc rgb '#1f78b4'\
 ,f2 u 1:($2*1E+00) t '3.58 atm' w p ps 3 pt 9 lw 3 lc rgb '#e31a1c'\
