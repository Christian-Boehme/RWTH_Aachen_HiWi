...
set out '../figures_postscripteps/LBV_CH4_Chan.eps'
...
p f1 u 1:($2*1E+00) t 'X_{CO_2}/(X_{CO_2}+X_{CH_4}) = 0.10' w p ps psize pt 5 lw plw lc rgb 'blue'\
 ,f4 u ($1):2 notitle w l lt 1 lw lwrefL lc rgb 'blue' dashtype 2\
 ,f5 u ($1):2 notitle w l lt 1 lw lwnewL lc rgb 'blue'\
 ,f2 u 1:($2*1E+00) t 'X_{CO_2}/(X_{CO_2}+X_{CH_4}) = 0.15' w p ps psize pt 7 lw plw lc rgb 'red'\
