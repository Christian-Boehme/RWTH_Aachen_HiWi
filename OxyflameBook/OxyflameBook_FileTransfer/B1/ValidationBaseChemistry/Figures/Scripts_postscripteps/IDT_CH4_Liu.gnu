...
set out '../figures_postscripteps/IDT_CH4_Liu.eps'
...
# Experiments
f1 = '../ExperimentalData/IDT_CH4_Liu_Mix2.txt'
# FM simulations
f4 = ARG1
f5 = ARG2

set label '{/Symbol f} = 0.5, p = 0.8 atm' at graph 0.03, graph 0.90
