...
set out '../figures_postscripteps/LBV_CH4_Kishore.eps'
...
p f1 u 1:($2*1E+00) t 'X_{CO_2}/(X_{CO_2}+X_{CH_4}) = 0.20' w p ps psize pt 5 lw plw lc rgb 'blue'\
 ,f4 u ($1):2 notitle w l lt 1 lw lwrefL lc rgb 'blue' dashtype 2\
 ,f5 u ($1):2 notitle w l lt 1 lw lwnewL lc rgb 'blue'\
 ,f2 u 1:($2*1E+00) t 'X_{CO_2}/(X_{CO_2}+X_{CH_4}) = 0.40' w p ps psize pt 7 lw plw lc rgb 'black'\
 ,f6 u ($1):2 notitle w l lt 1 lw lwrefL lc rgb 'black' dashtype 2\
 ,f7 u ($1):2 notitle w l lt 1 lw lwnewL lc rgb 'black'\
 ,f3 u 1:($2*1E+00) t 'X_{CO_2}/(X_{CO_2}+X_{CH_4}) = 0.60' w p ps psize pt 9 lw plw lc rgb 'red'\
