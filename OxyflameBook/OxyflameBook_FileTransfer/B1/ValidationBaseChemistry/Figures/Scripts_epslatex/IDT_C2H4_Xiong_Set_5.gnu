...
set out '../figures_epslatex/IDT_C2H4_Xiong_Set_5.tex'

set encoding utf8
set termoption enhanced

set xtics 0.0,0.10,2.0
...
# Experiments
f1 = '../ExperimentalData/IDT_C2H4_Xiong_Set_5.txt'
# FM simulations
f4 = ARG1
f5 = ARG2

set label '$\mathrm{\phi}$ = 1.0, p = 2 atm' at graph 0.03, graph 0.90

p f1 u 1:($2*1E+00) notitle w p ps psize pt 7 lw plw lc rgb 'blue'\
