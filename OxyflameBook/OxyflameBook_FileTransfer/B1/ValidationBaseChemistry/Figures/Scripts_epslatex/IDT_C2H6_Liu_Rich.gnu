...
set out '../figures_epslatex/IDT_C2H6_Liu_Rich.tex'
...
# Experiments
f1 = '../ExperimentalData/IDT_C2H6_Liu_LP_Rich.txt'
f2 = '../ExperimentalData/IDT_C2H6_Liu_HP_Rich.txt'
# FM simulations
f4 = ARG1
f5 = ARG2
f6 = ARG3
...
set label '$\mathrm{\phi}$ = 2.0' at graph 0.03, graph 0.90
