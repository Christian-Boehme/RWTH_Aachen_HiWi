...
set out '../figures_epslatex/IDT_CH4_HargisAndPetersen_025.tex'
...
# Experiments
f1 = '../ExperimentalData/IDT_CH4_HargisAndPetersen_025.txt'
# FM simulations
f4 = ARG1
f5 = ARG2

set label '$\mathrm{\phi}$ = 0.5, p = 1.75 atm' at graph 0.03, graph 0.90
