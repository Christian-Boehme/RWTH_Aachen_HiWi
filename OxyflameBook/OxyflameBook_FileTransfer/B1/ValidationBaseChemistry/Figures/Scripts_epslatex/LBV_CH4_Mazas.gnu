...
set out '../figures_epslatex/LBV_CH4_Mazas.tex'
...
p f1 u 1:($2*1E+00) t '$\mathrm{X_{CO_2} = 0.20}$' w p ps psize pt 5 lw plw lc rgb 'blue'\
 ,f2 u 1:($2*1E+00) t '$\mathrm{X_{CO_2} = 0.40}$' w p ps psize pt 7 lw plw lc rgb 'red'\
 ,f4 u ($1):2 notitle w l lt 1 lw lwrefL lc rgb 'blue' dashtype 6\
 ,f5 u ($1):2 notitle w l lt 1 lw lwnew lc rgb 'blue'\
 ,f6 u ($1):2 notitle w l lt 1 lw lwrefL lc rgb 'red' dashtype 6\
