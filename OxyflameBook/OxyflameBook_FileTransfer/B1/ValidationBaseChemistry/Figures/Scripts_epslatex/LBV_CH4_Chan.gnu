...
set out '../figures_epslatex/LBV_CH4_Chan.tex'
...
# Experiments
f1 = '../ExperimentalData/LBV_CH4_Chan_10.txt'
f2 = '../ExperimentalData/LBV_CH4_Chan_15.txt'
...
set label 'p = 1 atm, T = 307 K' at graph 0.03, graph 0.10

set key at graph 0.975, graph 0.95 spacing 1.0 samplen -1.5
p f1 u 1:($2*1E+00) t '$\mathrm{X_{CO_2}/(X_{CO_2}+X_{CH_4}) = 0.10}$' w p ps psize pt 5 lw plw lc rgb 'blue'\
 ,f2 u 1:($2*1E+00) t '$\mathrm{X_{CO_2}/(X_{CO_2}+X_{CH_4}) = 0.15}$' w p ps psize pt 7 lw plw lc rgb 'red'\
 ,f4 u ($1):2 notitle w l lt 1 lw lwref lc rgb 'blue' dashtype 6\
 ,f5 u ($1):2 notitle w l lt 1 lw lwnew lc rgb 'blue'\
 ,f6 u ($1):2 notitle w l lt 1 lw lwref lc rgb 'red' dashtype 6\
 ,f7 u ($1):2 notitle w l lt 1 lw lwnew lc rgb 'red'\
