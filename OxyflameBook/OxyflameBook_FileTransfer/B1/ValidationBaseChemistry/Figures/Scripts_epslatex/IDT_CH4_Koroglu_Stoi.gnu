...
set out '../figures_epslatex/IDT_CH4_Koroglu_Stoi.tex'
...
set label '$\mathrm{\phi}$ = 1.0' at graph 0.03, graph 0.90

set key at graph 0.975, graph 0.25 spacing 1.1 samplen -1.5
p f1 u 1:($2*1E+00) t '0.76 atm' w p ps psize pt 7 lw plw lc rgb 'blue'\
 ,f2 u 1:($2*1E+00) t '3.77 atm' w p ps psize pt 9 lw plw lc rgb 'black'\
