...
set out '../figures_epslatex/IDT_C2H4_Peng_Set_1.tex'
...
#set title ''
set xlabel '$\mathrm{1000}/T \mathrm{[K\textsuperscript{-1}]}$'
...
# Experiments
f1 = '../ExperimentalData/IDT_C2H4_Peng_Set_1.txt'
# FM simulations
f4 = ARG1
f5 = ARG2

set label '$\mathrm{\phi}$ = 0.5, p = 1 atm' at graph 0.03, graph 0.90
