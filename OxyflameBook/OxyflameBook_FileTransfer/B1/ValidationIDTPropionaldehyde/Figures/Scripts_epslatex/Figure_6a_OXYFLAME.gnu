...
set out '../figures_epslatex/B1b_Bio_Figure_6a.tex'
...
xpos = 0.25
set ylabel '$\mathrm{X_{C_6H_5OCH_3}}$ [-]' offset xpos,0
...
p f1 u ($1):3:4 notitle w filledcurves lc '#99ffcccc'\
 ...
 ,f3 u ($1):2 notitle w p pt 8 ps psize lw plw lc rgb '#1f78b4'\
 ,f5 u ($1*1000):(column('X_C6H5OCH3')) notitle w l lt 1 lw lwref lc rgb lcref dashtype 2\
 ,f6 u ($1*1000):(column('X_C6H5OCH3')) notitle w l lt 1 lw lwdet lc rgb lcdet dashtype 3\
 ,f7 u ($1*1000):(column('X_C6H5OCH3')) notitle w l lt 1 lw lwnew lc rgb lcnew\
