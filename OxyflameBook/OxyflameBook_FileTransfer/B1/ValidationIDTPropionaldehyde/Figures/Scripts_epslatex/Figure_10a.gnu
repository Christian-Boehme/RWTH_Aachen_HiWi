...
set out '../figures_epslatex/Figure_10a.tex'
...
xpos = -0.75
set ylabel '$\mathrm{X_{A_1}}$ [-]' offset xpos,0
...
p f1 u ($1):3:4 notitle w filledcurves lc '#99ffcccc'\
 ...
 ,f6 u ($1*1000):(column('X_A1')) notitle w l lt 1 lw lwdet lc rgb lcdet dashtype 3\
 ,f7 u ($1*1000):(column('X_A1')) notitle w l lt 1 lw lwnew lc rgb lcnew\
