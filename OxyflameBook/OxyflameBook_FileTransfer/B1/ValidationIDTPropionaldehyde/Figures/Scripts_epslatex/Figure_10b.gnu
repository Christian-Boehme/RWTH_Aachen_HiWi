...
set out '../figures_epslatex/Figure_10b.tex'
...
xpos = -0.75
set ylabel '$\mathrm{X_{C_5H_5CH_3}}$ [-]' offset xpos,0

set multiplot

# Chen CFB - paper
#f1 = '../ExperimentalData/Fig_10b_ToF.txt'
f2 = '../ExperimentalData/Fig_10b_GCRtQ.txt'
#f3 = '../ExperimentalData/Fig_10b_GCDB.txt'
# FM simulations
f5 = ARG1
f6 = ARG2
f7 = ARG3
...
p f2 u ($1):3:4 notitle w filledcurves lc '#99add8e6'\
 ...
 ,f6 u ($1*1000):(column('X_C5H5CH3-1')) notitle w l lt 1 lw lwdet lc rgb lcdet dashtype 3\
 ,f7 u ($1*1000):(column('X_C5H5CH3-1')) notitle w l lt 1 lw lwnew lc rgb lcnew\
