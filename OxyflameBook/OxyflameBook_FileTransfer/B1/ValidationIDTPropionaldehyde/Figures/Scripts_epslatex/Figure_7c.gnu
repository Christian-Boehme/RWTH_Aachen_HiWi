...
set out '../figures_epslatex/Figure_7c.tex'

set encoding utf8
set termoption enhanced

set xtics 0,2,10
set ytics 0,0.0003,0.0012
set mxtics 1
set mytics 1
...
xpos = 1.25
set ylabel '$\mathrm{X_{CH_2O}}$ [-]' offset xpos,0

set multiplot

# Chen CFB - paper
f1 = '../ExperimentalData/Fig_7c_ToF.txt'
#f2 = '../ExperimentalData/Fig_7c_GCRtQ.txt'
#f3 = '../ExperimentalData/Fig_7c_GCDB.txt'
# FM simulations
f5 = ARG1
f6 = ARG2
f7 = ARG3
...
p f1 u ($1):3:4 notitle w filledcurves lc '#99ffcccc'\
 ...
 ,f6 u ($1*1000):(column('X_CH2O')) notitle w l lt 1 lw lwdet lc rgb lcdet dashtype 3\
 ,f7 u ($1*1000):(column('X_CH2O')) notitle w l lt 1 lw lwnew lc rgb lcnew\

# ,f1 u ($1):2 notitle w p pt 2 ps 3 lw 3 lc rgb 'red'\
