...
set out '../figures_epslatex/Figure_7g.tex'
...
xpos = 1.25
set ylabel '$\mathrm{X_{C_3H_6}}$ [-]' offset xpos,0

set multiplot

# Chen CFB - paper
f1 = '../ExperimentalData/Fig_7g_ToF.txt'
#f2 = '../ExperimentalData/Fig_7g_GCRtQ.txt'
#f3 = '../ExperimentalData/Fig_7g_GCDB.txt'
# FM simulations
f5 = ARG1
f6 = ARG2
f7 = ARG3
...
p f1 u ($1):3:4 notitle w filledcurves lc '#99ffcccc'\
 ...
 ,f6 u ($1*1000):(column('X_C3H6')) notitle w l lt 1 lw lwdet lc rgb lcdet dashtype 3\
 ,f7 u ($1*1000):(column('X_C3H6')) notitle w l lt 1 lw lwnew lc rgb lcnew\
