...
set out '../figures_postscripteps/Figure_7l.eps'
...
xpos = -0.75
set ylabel 'X_{C_4H_6} [-]' offset xpos,0

set multiplot

# Chen CFB - paper
#f1 = '../ExperimentalData/Fig_7l_ToF.txt'
f2 = '../ExperimentalData/Fig_7l_GCRtQ.txt'
#f3 = '../ExperimentalData/Fig_7l_GCDB.txt'
# FM simulations
f5 = ARG1
f6 = ARG2
f7 = ARG3
...
p f2 u ($1):3:4 notitle w filledcurves lc '#99add8e6'\
 ...
 ,f6 u ($1*1000):(column('X_C4H6')) notitle w l lt 1 lw lwdet lc rgb 'black' dashtype 3\
 ,f7 u ($1*1000):(column('X_C4H6')) notitle w l lt 1 lw lwnew lc rgb 'black'\
