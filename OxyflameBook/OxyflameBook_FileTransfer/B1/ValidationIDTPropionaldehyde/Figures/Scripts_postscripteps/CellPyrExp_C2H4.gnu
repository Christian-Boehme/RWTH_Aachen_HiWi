...
set out '../figures_postscripteps/CellulosePyrolysisExperiment_C2H4.eps'
...
p f1 u ($1):2 notitle w p pt 5 ps psize lw plw lc rgb 'blue'\
 ...
 ,f3 u ($1/1000):(column('Y_C2H4')) notitle w l lt 1 lw lwrefCE lc rgb 'blue' dashtype 2\
 ,f5 u ($1/1000):(column('Y_C2H4')) notitle w l lt 1 lw lwrefCE lc rgb 'red' dashtype 2\
 ,f9 u ($1/1000):(column('Y_C2H4')) notitle w l lt 1 lw lwnewCE lc rgb 'blue'\
 ,f11 u ($1/1000):(column('Y_C2H4')) notitle w l lt 1 lw lwnewCE lc rgb 'red'\
