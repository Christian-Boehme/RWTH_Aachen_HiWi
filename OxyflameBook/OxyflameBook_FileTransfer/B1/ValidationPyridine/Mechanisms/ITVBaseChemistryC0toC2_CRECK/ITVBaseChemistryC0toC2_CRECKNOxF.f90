!----------------------------------------------------------
! ======= ITVBaseChemistryC0toC2_CRECKNOxF.f90 =======
!----------------------------------------------------------
...
!----------------------------------------------------------
      implicit none
      include 'ITVBaseChemistryC0toC2_CRECKNOxF90.h'
      real(DP) :: CDOT(110), W(1626), K(1626), &
      C(110), M(57), TEMP, PRESSURE
      integer ::  I
