...
set out '../figures_OxyflameBook/Wu_Lean_C5H5N.eps'
...
# Experiments
f1 = '../ExperimentalData/Wu_Lean_C5H5N.txt'
# FM simulations
f3 = ARG1
f4 = ARG2
f5 = ARG3
...
p f1 u 1:($2*1E+06) notitle w p ps psizeWL lw plw pt 7 lc rgb lcsymWL\
 ,f3 u 1:((column('X-C5H5N'))*1E+06) notitle w l lt 1 lw lwrefWL lc rgb lcrefWL dashtype 2\
 ,f4 u 1:((column('X-C5H5N'))*1E+06) notitle w l lt 1 lw lwdetWL lc rgb lcdetWL dashtype 3\
 ,f5 u 1:((column('X-C5H5N'))*1E+06) notitle w l lt 1 lw lwnewWL lc rgb lcnewWL\
