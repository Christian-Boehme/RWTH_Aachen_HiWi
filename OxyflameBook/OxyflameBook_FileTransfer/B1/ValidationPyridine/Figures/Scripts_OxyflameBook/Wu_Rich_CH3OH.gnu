...
set out '../figures_OxyflameBook/Wu_Rich_CH3OH.eps'
...
# Experiments
f1 = '../ExperimentalData/Wu_Rich_CH3OH.txt'
# FM simulations
f3 = ARG1
f4 = ARG2
f5 = ARG3
...
set ylabel 'X_{CH_3OH} [ppm]' offset -1.5,0

# create figures
p f1 u 1:($2*1E+00) notitle w p ps psizeWR lw plw pt 7 lc rgb lcsymWR\
 ,f3 u 1:((column('X-CH3OH'))*1E+06) notitle w l lt 1 lw lwrefWR lc rgb lcrefWR dashtype 2\
 ,f4 u 1:((column('X-CH3OH'))*1E+06) notitle w l lt 1 lw lwdetWR lc rgb lcdetWR dashtype 3\
 ,f5 u 1:((column('X-CH3OH'))*1E+06) notitle w l lt 1 lw lwnewWR lc rgb lcnewWR\
