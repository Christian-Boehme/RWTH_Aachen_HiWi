...
set out '../figures_OxyflameBook_epslatex/Figure_8a.tex'
...
xpos = 0.25
set ylabel '$X_\mathrm{C_2H_4}$ [-]' offset xpos,0

set multiplot

# Chen CFB - paper
f1 = '../ExperimentalData/Fig_8a_ToF.txt'
f2 = '../ExperimentalData/Fig_8a_GCRtQ.txt'
#f3 = '../ExperimentalData/Fig_8a_GCDB.txt'
# FM simulations
f5 = ARG1
f6 = ARG2
f7 = ARG3
...
p f1 u ($1):3:4 notitle w filledcurves lc '#99ffcccc'\
 ...
 ,f5 u ($1*1000):(column('X_C2H4')) notitle w l lt 1 lw lwref lc rgb lcref dashtype 2\
 ,f6 u ($1*1000):(column('X_C2H4')) notitle w l lt 1 lw lwdet lc rgb 'black' dashtype 3\
 ,f7 u ($1*1000):(column('X_C2H4')) notitle w l lt 1 lw lwnew lc rgb 'black'\
