...
set out '../figures_OxyflameBook_epslatex/Figure_6c.tex'
...
xpos = -0.50
set ylabel '$X_\mathrm{O_2}$ [-]' offset xpos,0

set multiplot

# Chen CFB - paper
f1 = '../ExperimentalData/Fig_6c_ToF.txt'
#f2 = '../ExperimentalData/Fig_6c_GCRtQ.txt'
#f3 = '../ExperimentalData/Fig_6c_GCDB.txt'
# FM simulations
f5 = ARG1
f6 = ARG2
f7 = ARG3
...
p f1 u ($1):3:4 notitle w filledcurves lc '#99ffcccc'\
 ...
 ,f6 u ($1*1000):(column('X_O2')) notitle w l lt 1 lw lwdet lc rgb 'black' dashtype 3\
 ,f7 u ($1*1000):(column('X_O2')) notitle w l lt 1 lw lwnew lc rgb 'black'\
