...
set out '../figures_OxyflameBook_epslatex/Figure_6d.tex'

set encoding utf8
set termoption enhanced

set xtics 0,2,10
set ytics 0,0.10,0.40
set mxtics 1
set mytics 1
...
xpos = -0.50
set ylabel '$X_\mathrm{H_2O}$ [-]' offset xpos,0

set multiplot

# Chen CFB - paper
f1 = '../ExperimentalData/Fig_6d_ToF.txt'
#f2 = '../ExperimentalData/Fig_6d_GCRtQ.txt'
#f3 = '../ExperimentalData/Fig_6d_GCDB.txt'
# FM simulations
f5 = ARG1
f6 = ARG2
f7 = ARG3
...
p f1 u ($1):3:4 notitle w filledcurves lc '#99ffcccc'\
 ...
 ,f6 u ($1*1000):(column('X_H2O')) notitle w l lt 1 lw lwdet lc rgb 'black' dashtype 3\
 ,f7 u ($1*1000):(column('X_H2O')) notitle w l lt 1 lw lwnew lc rgb 'black'\
