...
def CreateGraphic(tool, target_spec, norm, df, ini, lim, spec, graph, f, fs, q, DTness, pa): # TODO lim is senseless
...
def GenerateGraphic(df, target_spec, initial_species, limit, font, fontsize, cnode, q, NormOutGoing, DThickness, single, odir, pa):
