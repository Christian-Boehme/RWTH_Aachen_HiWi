...
filename90 = '~/p0021020/Pooria/SINGLES/PostProcessing/VolatileFlameStandOffDistance/Data/4_NormalizedGrid/Sim_Coal_EffectOfSize_Air.csv';
fileID90 = fopen(filename90, 'r');
data90 = readtable(filename90, 'Delimiter', '\t');
fclose(fileID90);
filename125 = '~/p0021020/Pooria/SINGLES/PostProcessing/VolatileFlameStandOffDistance/Data/4_NormalizedGrid/Sim_WS_EffectOfSize_Air.csv';
...
xlabel('$D_\mathrm{p} \mathrm{[\mu m]}$','fontsize',FZ,'interpreter','latex');
...
saveas(gcf, 'figures/VolFlameDistance_CoalBio_SizeEffect_Air.eps', 'epsc');
