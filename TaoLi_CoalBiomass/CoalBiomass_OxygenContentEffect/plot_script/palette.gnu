...
# Lines 
set style line 41 lt 1 lw 3 dt (2,1,0.5,1)  lc rgb "#e41a1c"   # red
set style line 42 lt 2 lw 3 dt (2,2,2,2)     lc rgb "#377eb8"   # blue
set style line 43 lt 3 lw 3 dt 1  lc rgb "#4daf4a"   # green
set style line 44 lt 4 lw 6 dt (0.1,0.4,0.1,0.4)  lc rgb "#ff7f00"   # purple
set style line 45 lt 1 lw 1 dt (2,2,2,2)  lc rgb "#984ea3"   # orange
set style line 46 lt 1 lw 1 dt 1          lc rgb "black"     # black 
set style line 47 lt 4 lw 4 dt (1,1,1,1)  lc rgb "#a65628"   # brown
set style line 48 lt 4 lw 4 dt (1,1,1,1)  lc rgb "#f781bf"   # pink
