...
## Job name and files
#SBATCH --job-name=06_CH4_Air_Combustion_1000F

## OUTPUT AND ERROR
#SBATCH -o job.06_CH4_Air_Combustion_1000F.%j.out
#SBATCH -e job.06_CH4_Air_Combustion_1000F.%j.err
...
args='-i 06_CH4_Air_Combustion_1000Files.input'

date
##$MPIEXEC $FLAGS_MPI_BATCH $I_MPI_PIN $I_MPI_PIN_DOMAIN ./$exe $args
##$MPIEXEC $FLAGS_MPI_BATCH 
./$exe $args 2>&1 | tee job_06_CH4_Air_Combustion_test.out
date
