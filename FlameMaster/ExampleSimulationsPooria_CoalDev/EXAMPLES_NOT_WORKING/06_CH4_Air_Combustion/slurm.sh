...
## Job name and files
#SBATCH --job-name=06_CH4_Air_Combustion

## OUTPUT AND ERROR
#SBATCH -o job.06_CH4_Air_Combustion.%j.out
#SBATCH -e job.06_CH4_Air_Combustion.%j.err
