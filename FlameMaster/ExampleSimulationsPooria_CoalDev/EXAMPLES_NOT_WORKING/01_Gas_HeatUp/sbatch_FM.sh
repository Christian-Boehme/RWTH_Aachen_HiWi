...
exe='/home/cb376114/Programs/FlameMaster/FlameMaster_Branch_jl_dco_activated_ParticleModel/Bin/bin/FlameMan'


### executable arguments
args='-i 01_Gas_HeatUp.input'
