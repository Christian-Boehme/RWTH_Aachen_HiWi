...
## Job name and files
#SBATCH --job-name=07_CH4_Air_Combustion_D16mm

## OUTPUT AND ERROR
#SBATCH -o job.07_CH4_Air_Combustion_D16mm.%j.out
#SBATCH -e job.07_CH4_Air_Combustion_D16mm.%j.err
...
#args='-i 07_CH4_Air_Combustion_D16mm.input'
args='-i 07_CH4_Air_Combustion_D16mm.input -s ./Outputs/1ms_4ms/4_CH4_p01t4.00e+00ms.tout'

date
##$MPIEXEC $FLAGS_MPI_BATCH $I_MPI_PIN $I_MPI_PIN_DOMAIN ./$exe $args
##$MPIEXEC $FLAGS_MPI_BATCH 
./$exe $args 2>&1 | tee job_07_CH4_Air_Combustion_D16mm.out
date
