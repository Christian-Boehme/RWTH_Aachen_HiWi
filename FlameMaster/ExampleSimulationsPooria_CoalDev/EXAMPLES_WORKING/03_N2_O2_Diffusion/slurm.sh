...
## Job name and files
#SBATCH --job-name=03_N2_O2_Diffusion

## OUTPUT AND ERROR
#SBATCH -o job.03_N2_O2_Diffusion.input.%j.out
#SBATCH -e job.03_N2_O2_Diffusion.input.%j.err
