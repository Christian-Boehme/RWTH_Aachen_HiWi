...
## Job name and files
#SBATCH --job-name=04_01_CH4_Air_Diffusion_TempGrad300K

## OUTPUT AND ERROR
#SBATCH -o job.04_01_CH4_Air_Diffusion_TempGrad_300K.%j.out
#SBATCH -e job.04_01_CH4_Air_Diffusion_TempGrad_300K.%j.err
...
args='-i 04_01_CH4_Air_Diffusion_TempGrad300K.input'

date
##$MPIEXEC $FLAGS_MPI_BATCH $I_MPI_PIN $I_MPI_PIN_DOMAIN ./$exe $args
##$MPIEXEC $FLAGS_MPI_BATCH 
./$exe $args 2>&1 | tee job_04_01_CH4_Air_Diffusion_TempGrad300K.out
date
