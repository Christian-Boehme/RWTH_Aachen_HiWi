...
## Job name and files
#SBATCH --job-name=02_O2_N2_Diffusion

## OUTPUT AND ERROR
#SBATCH -o job.02_O2_N2_Diffusion.input.%j.out
#SBATCH -e job.02_O2_N2_Diffusion.input.%j.err
